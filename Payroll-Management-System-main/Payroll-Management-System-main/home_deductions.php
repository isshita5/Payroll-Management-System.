...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Aryan, Isshita and Bootstrap Contributors">
          ...
          <ul class="nav nav-justified">
            ...
            <li>
              ...
              <form class="form-horizontal" action="#" name="form">
                ...
                <div class="form-group">
                  <label class="col-sm-5 control-label">HRA (House Rent Allowances) :</label>
                  <div class="col-sm-4">
                    <?php echo $bir; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">DA (Dearness Allowances) :</label>
                  <div class="col-sm-4">
                    <?php echo $gsis; ?>.00
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-5 control-label">Other Allowances :</label>
                  <div class="col-sm-4">
                    <?php echo $love; ?>.00
                  </div>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="add_deductions.php" name="form" method="post">
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label">DA</label>
                  <div class="col-sm-8">
                    <input type="text" name="gsis" class="form-control" value="<?php echo $gsis; ?>" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Other Allowances</label>
                  <div class="col-sm-8">
